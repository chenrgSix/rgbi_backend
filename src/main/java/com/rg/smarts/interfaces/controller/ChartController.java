...
//                "{明确的数据分析结论、越详细越好，不要生成多余的注释}";
        ...
        boolean saveResult = chartApplicationService.save(chart);
    ...
    public BaseResponse<BiResponse> genChartBuAiAsync(@RequestPart("file") MultipartFile multipartFile,
        ...
        CompletableFuture.runAsync(()->{//使用线程池
            ...
            boolean b = chartApplicationService.updateById(updateChart);
            if (!b){
    ...
    public BaseResponse<BiResponse> genChartBuAiAsyncMq(@RequestPart("file") MultipartFile multipartFile,
        ...
        // 限流判断，每个用户一个限流器
        redisLimiterManager.doRateLimit("genChartByAi_" + loginUser.getId());
        BiResponse chart = chartApplicationService.getChartMQ(multipartFile, genChartByAiRequest);
    ...
    public BaseResponse<BiResponse> retryGenChart(@RequestBody final ChartRetryRequest chartQueryRequest, HttpServletRequest request) {
        ...
        BiResponse chart = chartApplicationService.retryGenChart(chartRetry);
        return ResultUtils.success(chart);
    }
    ...
    public BaseResponse<Long> addChart(@RequestBody ChartAddRequest chartAddRequest, HttpServletRequest request) {
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        chart.setUserId(loginUser.getId());
        boolean result = chartApplicationService.save(chart);
    ...
    public BaseResponse<Boolean> updateChart(@RequestBody ChartUpdateRequest chartUpdateRequest) {
        ...
        Chart oldChart = chartApplicationService.getById(id);
        ThrowUtils.throwIf(oldChart == null, ErrorCode.NOT_FOUND_ERROR);
        boolean result = chartApplicationService.updateById(chart);
    ...
    public BaseResponse<Chart> getChartById(long id, HttpServletRequest request) {
        ...
        Chart chart = chartApplicationService.getById(id);
        if (chart == null) {
    ...
    public BaseResponse<Page<Chart>> listChartByPage(@RequestBody ChartQueryRequest chartQueryRequest) {
        ...
        Page<Chart> chartPage = chartApplicationService.page(new Page<>(current, size),
